...
fname1 = folder + mname.replace('/','-') + '_Rankings_' + lang1 + '.txt'
fname2 = folder + mname.replace('/','-') + '_Rankings_' + lang2 + '.txt'

fcand1 = folder + mname.replace('/', '-') + '_Scores_' + lang1 + '.txt'
fcand2 = folder + mname.replace('/', '-') + '_Scores_' + lang2 + '.txt'
